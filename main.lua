...
function UILibrary:Main(PrjName,HideKey,GameName)
	...
	HideMain.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
	...
	OnEffect.Volume = 1
	OnEffect.SoundId = "rbxassetid://8486683243" 
	OnEffect:Play()
	...
	function Tabs:Nofitication(Text)
		...
		NofiticationLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
	...
	function Tabs:NewTab(TabName)
		...
		Elements.ScrollBarImageColor3 = Color3.fromRGB(205, 0, 0)
		...
		for index,page in next,Pages:GetChildren() do
			if page.Name ~= "UIPageLayout" and (page.Name == Frame.Name and index == 2) then
				...
				TweenService:Create(TabButton,TweenInfo.new(0.25),{BackgroundTransparency = 0.3,BackgroundColor3 = Color3.fromRGB(255, 0, 0)}):Play()	
		...
		function ElementsLib:NewSection(SectionName)
			...
			function InSection:NewToggle(ToggleText,UserFunc,defbool)
				...
				local ClickEffect = Instance.new("Sound")
				...
				Checker.BackgroundColor3 = Color3.fromRGB(205, 0, 0)
				...
				ClickEffect.SoundId = "rbxassetid://8551372796" 
			...
			function InSection:NewSlider(SliderText,min,max,precise,UserFunc,defvalue)
				...
				Circle.AnchorPoint = Vector2.new(0, 0.5)
				Circle.BackgroundColor3 = Color3.fromRGB(205, 0, 0)
				Circle.BorderSizePixel = 0
				...
				Progress.BackgroundColor3 = Color3.fromRGB(205, 0, 0)
			...
			function InSection:NewDropdown(placeholder,Selectables,func,IsMulti)
				...
				CloseButton.TextColor3 = Color3.fromRGB(235, 0, 0)
				...
				local function NewSelectable(Text,val)
					...
					ChoosedCircle.BackgroundColor3 = Color3.fromRGB(200, 0, 0)
					...
					InnerCircle.BackgroundColor3 = Color3.fromRGB(205, 0, 0)
	...
	function InSection:NewTextBox(placeholder, callback)
				...
				TextBox.Parent = SectionElements
...
-- Gaster#0971 recreator
			...
			function InSection:NewButton(btnText,func)
				...
				Button.MouseButton1Down:Connect(function()
					TweenService:Create(Button,TweenInfo.new(0.25),{BackgroundTransparency = 0.3,BackgroundColor3 = Color3.fromRGB(255, 0, 0)}):Play()
				end)
